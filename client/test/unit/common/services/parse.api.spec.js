  ...
  describe('GIVEN the parseApi', function () {
    ...
    describe('WHEN get all is requested', function () {
      ...
      it('THEN it should call the correct endpoint', function () {
        $httpBackend
          .expect('GET', PARSE_URLS.CLASSES + chosenClass + '?count=1&limit=10&order=-createdAt&skip=0')
      ...
      it('THEN it should pass the service credentials', function () {
        $httpBackend
          .expect('GET', PARSE_URLS.CLASSES + 'aClass?count=1&limit=10&order=-createdAt&skip=0', undefined,
          function (headers) {
